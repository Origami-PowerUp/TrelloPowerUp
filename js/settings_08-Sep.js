...
//                                        t.member('username','id','fullName').then(function (member) {
                                            ...
                                            ]).spread((cardData,assignedTo,member,boardName,startDate)=>{
//                                                let d = new Date(startDate)
//                                                let ty = d.getFullYear();
//                                                let tm = d.getMonth();
//                                                let td = d.getDate();
                              //                  console.log('startDate = ', startDate, ' today date = ', ty,'-',tm+1,'-',td, ' and d = ', d)
                                                        
//                                                        if(assignedTo.includes("anial")){
//                                                            console.log('user matched to clear time')
...
//                                                        } 
                               ...
                               //                         console.log('saving time')
                                        ...
                                        if(assignedTo && assignedTo.includes("99989898jaz")){
